...
// init_3darray log_sel_inif(1,2,1,2,1,nbloq_selflo,phs_Selflo);
 ...
 init_bounded_vector log_L50flom(1,nbloq_selflo,1.9,2.6,phs_Selflo);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50flomL(1,nbloq_selflo,0.4,0.6,phs_Selflo);


 init_bounded_vector log_L50floh(1,nbloq_selflo,1.3,2.1,phs_Selflo);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50flohL(1,nbloq_selflo,0.2,0.6,phs_Selflo);
 ...
 init_bounded_vector log_L50crum(1,nbloq_selcru,1.8,2.2,phs_Selcru);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50crumL(1,nbloq_selcru,0.2,0.6,phs_Selcru);
 
 
 init_bounded_vector log_L50cruh(1,nbloq_selcru,1.3,1.7,phs_Selcru);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50cruhL(1,nbloq_selcru,0.5,0.8,phs_Selcru);
