...
std1 <- read.table('../../output/Ffree/Lam.std', header = T, sep = '', na='NA', fill = T)
...
ggsave(plot_rec, filename = "../../figures/Ffree/VarPop1_Rec.png", width=7, height=8, dpi=300)
...
ggsave(plot_B, filename = "../../figures/Ffree/VarPop2_Biom.png", width=8, height=6.5, dpi=300)
...
ggsave(p12, filename = "../../figures/Ffree/VarPop3_Fh.png", width=8, height=6.5, dpi=300)
