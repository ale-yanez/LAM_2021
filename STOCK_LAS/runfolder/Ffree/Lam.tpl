...
// parametros reclutamientos, desvíos R, No y mortalidades)
 ...
 init_bounded_vector log_Fm(1,nyears,-20,2,phs_F); // // log  mortalidad por pesca por flota machos F LIMITADA EN 0.8187 !!!!!!
 init_bounded_vector log_Fh(1,nyears,-20,2,phs_F); // log  mortalidad por pesca por flota
