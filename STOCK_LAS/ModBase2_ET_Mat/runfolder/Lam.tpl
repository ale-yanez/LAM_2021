...
// init_3darray log_sel_inif(1,2,1,2,1,nbloq_selflo,phs_Selflo)
 ...
 init_bounded_vector log_L50flom(1,nbloq_selflo,1.9,2.5,phs_Selflo);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50flomL(1,nbloq_selflo,0.6,1.0,phs_Selflo);


 init_bounded_vector log_L50floh(1,nbloq_selflo,1.1,1.9,phs_Selflo);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50flohL(1,nbloq_selflo,0.15,0.3,phs_Selflo);


 init_bounded_vector log_L50crum(1,nbloq_selcru,1.6,1.9,phs_Selcru);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50crumL(1,nbloq_selcru,0.8,1.1,phs_Selcru);
 
 
 init_bounded_vector log_L50cruh(1,nbloq_selcru,0.9,1.8,phs_Selcru);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50cruhL(1,nbloq_selcru,0.3,1.0,phs_Selcru);
 ...
 */
 ...
 if (active(log_Fh)){
 penalty+=10*(square(log_Fh(1)-mean(log_Fh))+square(log_Fh(2)-mean(log_Fh))+square(log_Fh(3)-mean(log_Fh))+square(log_Fh(4)-mean(log_Fh))); }
 //penalty+=1*(square(log_Fh(1)-mean(log_Fh))+square(log_Fh(2)-mean(log_Fh))+square(log_Fh(3)-mean(log_Fh))+square(log_Fh(4)-mean(log_Fh))+square(log_Fh(5)-mean(log_Fh))+square(log_Fh(6)-mean(log_Fh))); }

 if (active(log_Fm)){
 penalty+=10*(square(log_Fm(1)-mean(log_Fm))+square(log_Fm(2)-mean(log_Fm))+square(log_Fm(3)-mean(log_Fm))+square(log_Fm(4)-mean(log_Fm))); }
 //penalty+=1*(square(log_Fm(1)-mean(log_Fm))+square(log_Fm(2)-mean(log_Fm))+square(log_Fm(3)-mean(log_Fm))+square(log_Fm(4)-mean(log_Fm))+square(log_Fm(5)-mean(log_Fm))+square(log_Fm(6)-mean(log_Fm))); }
