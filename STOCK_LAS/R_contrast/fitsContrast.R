...
out <- read.admb("../base/output/Lam")
out1 <- read.admb("../base4/output/Lam")
out2 <- read.admb("../baseMat/output/Lam")
out3 <- read.admb("../baseFrancis/output/Lam")
out4 <- read.admb("../baseCru/output/Lam")
...
p1_2 <-  ggplot(NULL, aes(x=yrs)) +
  ...
  geom_line(aes(y= predD, colour="MB_3")) +
  geom_line(aes(y= predD2, colour="BaseMat")) +
  geom_line(aes(y= predD3, colour="Francis")) +
  geom_line(aes(y= predD4, colour="cvCru")) +
  geom_errorbar(aes(ymin = obsD95i, ymax = obsD95s), colour='black', width=0.6) +
  scale_colour_manual(name='', values=c('MB_3'='royalblue3', 'BaseMat'='gold2', 'Francis'='green', 'cvCru'='red', 'Observado'='black'), guide='legend') +
  guides(colour = guide_legend(override.aes = list(linetype=c(1,1,1,1,0), shape=c(NA,NA,NA,NA, 21)))) +
...
p2 <-  ggplot(NULL, aes(x=yrs)) +
  ...
  geom_line(aes(y= predC, colour="CPUE Est")) +
  geom_line(aes(y= predC2, colour="CPUE Est2")) +
  geom_line(aes(y= predC3, colour="CPUE Est3")) +
  geom_line(aes(y= predC4, colour="CPUE Est4")) +
  geom_errorbar(aes(ymin = obsC95i, ymax = obsC95s), colour='black', width=0.6) +
  #scale_colour_manual(name='', values=c('CPUE Est'='royalblue3', 'CPUE Obs'='black'), guide='legend') +
  scale_colour_manual(name='', values=c('CPUE Est'='royalblue3', 'CPUE Est2'='gold2', 'CPUE Est3'='green', 'CPUE Est4'='red', 'CPUE Obs'='black'), guide='legend') +
  guides(colour = guide_legend(override.aes = list(linetype=c(1,1,1,1,0), shape=c(NA,NA,NA,NA, 21)))) +
...
p3 <-  ggplot(NULL, aes(x=yrs)) +
  ...
  geom_line(aes(y= predS, colour="Crucero Est")) +
  geom_line(aes(y= predS2, colour="Crucero Est2")) +
  geom_line(aes(y= predS3, colour="Crucero Est3")) +
  geom_line(aes(y= predS4, colour="Crucero Est4")) +
  geom_errorbar(aes(ymin = obsS95i, ymax = obsS95s), colour='black', width=0.6) +
  #scale_colour_manual(name='', values=c('Crucero Est'='royalblue3', 'Crucero Obs'='black'), guide='legend') +
  scale_colour_manual(name='', values=c('Crucero Est'='royalblue3', 'Crucero Est2'='gold2', 'Crucero Est3'='green', 'Crucero Est4'='red', 'Crucero Obs'='black'), guide='legend') +
  guides(colour = guide_legend(override.aes = list(linetype=c(1,1,1,1,0), shape=c(NA,NA,NA,NA, 21)))) +
...
plot2
ggsave(plot2, filename='figures/ComparaIndex.png', width=6.5, height=8, dpi=300)

std1 <- read.table('../base4/output/Lam.std', header = T, sep = '', na='NA', fill = T)
std2 <- read.table('../baseMat/output/Lam.std', header = T, sep = '', na='NA', fill = T)
std3 <- read.table('../baseFrancis/output/Lam.std', header = T, sep = '', na='NA', fill = T)
std4 <- read.table('../baseCru/output/Lam.std', header = T, sep = '', na='NA', fill = T)
...
p10 <- ggplot(data = NULL, aes(x = yrs)) + 
  geom_line(aes(y = BT_est1, colour = 'MB_3', linetype = 'MB_3')) +
  geom_line(aes(y = BT_est2, colour = 'BaseMat', linetype = 'BaseMat')) +
  geom_line(aes(y = BT_est3, colour = 'Francis', linetype = 'Francis')) +
  geom_line(aes(y = BT_est4, colour = 'cvCru', linetype = 'cvCru')) +
  ...
  scale_linetype_manual(name = '',
                        values = c('solid', 'twodash', 'solid', 'solid'),
                        limits = c('MB_3', 'BaseMat', 'Francis', 'cvCru'),
                        breaks = c('MB_3', 'BaseMat', 'Francis', 'cvCru'))
p10 <- p10 + theme_bw() + 
...
p11 <- ggplot(data = NULL, aes(x = yrs)) + 
  geom_line(aes(y = BD_est1, colour = 'MB_3', linetype = 'MB_3')) +
  geom_line(aes(y = BD_est2, colour = 'BaseMat', linetype = 'BaseMat')) +
  geom_line(aes(y = BD_est3, colour = 'Francis', linetype = 'Francis')) +
  geom_line(aes(y = BD_est4, colour = 'cvCru', linetype = 'cvCru')) +
  #geom_ribbon(data=NULL, aes(ymin=BT1_lwr, ymax=BT1_upr), fill = 'grey60', alpha = 0.4) + 
  #geom_line(aes(y = c(rep(1,length(yrs))), colour = 'Brms', linetype = '')) +
  scale_color_manual(name = '',
                     values = c('royalblue3', 'gold2', 'green', 'red'),
