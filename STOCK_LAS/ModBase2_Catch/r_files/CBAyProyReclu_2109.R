...
setwd(dir.2);
file.copy('../input/stock_LAS.dat', '../CBA_Proy/')
...
system('./Lam -ind stock_LAS.dat')

 # Run Model con NUMERO Y TASA DE PROYECCIÓN PBRs ESCENARIOS ####

# escenario 1: Ro*1
Tasa_bdpr <- c(0.3,0.4,0.45, 0.743633)
...
ggsave(p1_2, filename = "../figures/Fig1_2BD.pdf", width=8, height=6.5, dpi=300)
...
p2_2
ggsave(p2_2, filename = "../figures/Fig2_2BD.pdf", width=8, height=6.5, dpi=300)
