 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  log_L50flom.allocate(1,nbloq_selflo,1.9,2.6,phs_Selflo,"log_L50flom");
  log_sdL50flomL.allocate(1,nbloq_selflo,0.4,0.6,phs_Selflo,"log_sdL50flomL");
  log_L50floh.allocate(1,nbloq_selflo,1.3,2.1,phs_Selflo,"log_L50floh");
  log_sdL50flohL.allocate(1,nbloq_selflo,0.2,0.6,phs_Selflo,"log_sdL50flohL");
  log_L50crum.allocate(1,nbloq_selcru,1.8,2.2,phs_Selcru,"log_L50crum");
  log_sdL50crumL.allocate(1,nbloq_selcru,0.2,0.6,phs_Selcru,"log_sdL50crumL");
  log_L50cruh.allocate(1,nbloq_selcru,1.3,1.7,phs_Selcru,"log_L50cruh");
  log_sdL50cruhL.allocate(1,nbloq_selcru,0.5,0.8,phs_Selcru,"log_sdL50cruhL");
  ...
  log_Fm.allocate(1,nyears,-20,1,phs_F,"log_Fm");
  log_Fh.allocate(1,nyears,-20,1,phs_F,"log_Fh");
