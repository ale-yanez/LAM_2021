...
// init_3darray log_sel_inif(1,2,1,2,1,nbloq_selflo,phs_Selflo)
 ...
 init_bounded_vector log_L50flom(1,nbloq_selflo,1.5,2.5,phs_Selflo);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50flomL(1,nbloq_selflo,0.6,1.4,phs_Selflo);
 ...
 init_bounded_vector log_L50crum(1,nbloq_selcru,1.6,2.2,phs_Selcru);// Podría ser bounded (0.67,1.94)
 init_bounded_vector log_sdL50crumL(1,nbloq_selcru,0.7,1.5,phs_Selcru);
