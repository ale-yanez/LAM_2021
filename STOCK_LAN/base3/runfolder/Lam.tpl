 ...
 */
 ...
 if (active(log_Fm)){
 penalty+=100*(square(log_Fm(1)-mean(log_Fm))+square(log_Fm(4)-mean(log_Fm))+square(log_Fm(5)-mean(log_Fm))+square(log_Fm(6)-mean(log_Fm))); } //+square(log_Fm(6)-mean(log_Fm))); }
