...
ggsave(plot, filename='../../figures/LogSel_Ffree/Fig1.png', width=6.5, height=8, dpi=300)
...
ggsave(psel, filename = "../../figures/Ffree/Fig8.png")
...
ggsave(psel2, filename = "../../figures/LogSel_Ffree/Fig8_2.png", width=7, height=8, dpi=300)
...
ggsave(p1, filename = "../../figures/LogSel_Ffree/Fig2_TallasM_flo.png")
...
ggsave(p2, filename = "../../figures/LogSel_Ffree/Fig3_TallasH_flo.png")
...
ggsave(p3, filename = "../../figures/LogSel_Ffree/Fig4_TallasM_cru.png")
...
ggsave(p4, filename = "../../figures/LogSel_Ffree/Fig5_TallasH_cru.png")
...
ggsave(plot1, filename = "../../figures/LogSel_Ffree/Fig6_1.png", width=9, height=6, dpi=300)
ggsave(plot2, filename = "../../figures/LogSel_Ffree/Fig6_2.png", width=6.5, height=8, dpi=300)
...
ggsave(plot3, filename = "../../figures/LogSel_Ffree/Fig7_1.png", width=9, height=6, dpi=300)
ggsave(plot4, filename = "../../figures/LogSel_Ffree/Fig7_2.png", width=6.5, height=8, dpi=300)
