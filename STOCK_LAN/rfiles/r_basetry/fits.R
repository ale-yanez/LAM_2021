...
ggsave(plot, filename='../../figures/basetry/Fig1.png', width=6.5, height=8, dpi=300)
...
ggsave(plot1, filename = "../../figures/basetry/Fig6_1.png", width=9, height=6, dpi=300)
ggsave(plot2, filename = "../../figures/basetry/Fig6_2.png", width=6.5, height=8, dpi=300)
...
ggsave(plot3, filename = "../../figures/basetry/Fig7_1.png", width=9, height=6, dpi=300)
ggsave(plot4, filename = "../../figures/basetry/Fig7_2.png", width=6.5, height=8, dpi=300)
...
ggsave(psel, filename = "../../figures/basetry/Fig8.png")
...
ggsave(psel2, filename = "../../figures/basetry/Fig8_2.png", width=7, height=8, dpi=300)
...
ggsave(p1, filename = "../../figures/basetry/Fig2_TallasM_flo.png")
...
ggsave(p2, filename = "../../figures/basetry/Fig3_TallasH_flo.png")
...
ggsave(p3, filename = "../../figures/basetry/Fig4_TallasM_cru.png")
...
ggsave(p4, filename = "../../figures/basetry/Fig5_TallasH_cru.png")
