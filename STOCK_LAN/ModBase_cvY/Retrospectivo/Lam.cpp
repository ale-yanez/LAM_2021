 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  log_L50cruh.allocate(1,nbloq_selcru,0.7,1.1,phs_Selcru,"log_L50cruh");
  log_sdL50cruhL.allocate(1,nbloq_selcru,-0.15,-0.09,phs_Selcru,"log_sdL50cruhL");
  log_L50crum.allocate(1,nbloq_selcru,1.2,1.7,phs_Selcru,"log_L50crum");
  log_sdL50crumL.allocate(1,nbloq_selcru,0.7,1.1,phs_Selcru,"log_sdL50crumL");
