...
system('mkdir ../../estim_nm/nm_logistic') #otra opción
file.copy('../../input/logistic_sel/stock_LAN.dat', '../../estim_nm/nm_logistic/')
file.copy('../../runfolder/logistic_sel/Lam.tpl', '../../estim_nm/nm_logistic/')


# Corre modelos ####
# Tamaños de muestra originales (50 50 25 25)

system('mv ../../estim_nm/nm_logistic/stock_LAN.dat ../../estim_nm/nm_logistic/stock_LANnm.dat')
...
dat1_nor        <- lisread("../../estim_nm/nm_logistic/stock_LANnm.dat");
#dat1_nor        <- lisread("../../input/lamsur2008.dat");
names(dat1_nor) <- str_trim(names(dat1_nor), side="right")
dat_nor         <- dat1_nor
rep           <- reptoRlist('../../estim_nm/nm_logistic/Lam.rep')
...
#system('cp -)
writeData(paste("../../estim_nm/nm_logistic/stock_LAN2020.dat",sep=""), dat_nor, append=FALSE)
system('mv ../../estim_nm/nm_logistic/stock_LAN2020.dat ../../estim_nm/nm_logistic/stock_LAN.dat')
